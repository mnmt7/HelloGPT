...
const initChain = async (transcript, metadataString, research, topic) => {
  try {
    ...
    const question = `Write me a script for a new video that provides a commentary on this video in a light hearted, joking manner. It should complement ${topic}. It should not be more than 700 characters.`;
