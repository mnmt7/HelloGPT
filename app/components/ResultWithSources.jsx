...
const ResultWithSources = ({ messages, pngFile, maxMsgs }) => {
  ...
  return (
    <div
      ...
      className={`bg-slate-200 border-solid border-2 border-black p-10 rounded-3xl shadow-lg mb-8 overflow-y-scroll h-[500px] max-h-[500px] flex flex-col space-y-4 ${
